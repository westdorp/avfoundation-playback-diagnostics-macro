...
/// Returns `true` when `classDecl` already conforms to `Sendable`.
///
/// Lookup strategy:
/// 1. Direct inheritance on the class declaration.
/// 2. Matching `extension Type: Sendable` declarations in the source file.
/// 3. Matching `extension Type: Sendable` declarations in lexical context roots.
...
private func sourceFile(containing node: Syntax) -> SourceFileSyntax? {
    var current = node
...
private func inheritedTypesContainSendable(_ inheritedTypes: InheritedTypeListSyntax?) -> Bool {
